...
if __name__ == "__main__":
    ...
    args_parser.add_argument('--output-file', type=str, dest='filename',
                             help='The file to save the trained agent weights to', default="trained_agent_weights.pth")
    args_parser.add_argument('--n', type=str, dest='n_rollouts',
                             help='The number of trajectories to collect whilst training', default=1000)
